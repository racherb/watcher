...
FILE.NO_ALTERATION = '0'
FILE.ALTERATION = '1'
FILE.CONTENT_ALTERATION = '2'
FILE.SIZE_ALTERATION = '3'
FILE.CHANGE_TIME_ALTERATION = '4'           --CTIME
FILE.MODIFICATION_TIME_ALTERATION = '5'     --MTIME
FILE.INODE_ALTERATION = '6'
FILE.OWNER_ALTERATION = '7'
FILE.GROUP_ALTERATION = '8'
